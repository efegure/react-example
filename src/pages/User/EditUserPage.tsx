...
const EditUserPage: React.FC = () => {
    ...
    const handleEdit = ({ firstName, lastName, email }: { firstName: string; lastName: string; email: string }) => {
        if (id) {
    ...
    return (
        <div style={{ position: 'relative', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
            ...
            <UserForm loading={loading} onSubmit={handleEdit} user={selectedUser}></UserForm>
        </div>
    )
}
