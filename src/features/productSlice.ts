...
export const addProduct = createAsyncThunk(
  'product/add',
  async (product: Partial<Product>) => await api.addProduct(product)
)
...
export const editProduct = createAsyncThunk(
  'product/edit',
  async (product: Product) => await api.editProduct(product)
)
export const addToFavorite = createAsyncThunk(
  'product/favorite',
  async (id: string) => await api.addToFavorite(id)
)
export const searchProduct = createAsyncThunk(
  'product/search',
  async (payload: { query: string; category?: string }) => {
